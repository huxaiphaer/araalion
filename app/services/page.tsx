...
const services = [
  ...
  },
  {
    ...
    secondaryImage: "https://web-xolb0reinzyryh7e2bwjykqy.153.75.248.169.sslip.io/08_ict_equipment.jpeg",
    icon: (
      <svg className="w-9 h-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    secondaryImage: "https://web-xolb0reinzyryh7e2bwjykqy.153.75.248.169.sslip.io/11_branding_promotional_merchandise.jpeg",
    icon: (
      <svg className="w-9 h-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
